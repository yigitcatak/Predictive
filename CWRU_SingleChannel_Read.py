...
torch.save(x_train,'CWRU/presplit/singlechannel/x_train.pt')
torch.save(x_test,'CWRU/presplit/singlechannel/x_test.pt')
torch.save(y_train,'CWRU/presplit/singlechannel/y_train.pt')
torch.save(y_test,'CWRU/presplit/singlechannel/y_test.pt')