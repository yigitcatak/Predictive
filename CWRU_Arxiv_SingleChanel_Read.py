...
torch.save(x_train,'CWRU/presplit/arxiv_singlechannel/x_train.pt')
torch.save(x_test,'CWRU/presplit/arxiv_singlechannel/x_test.pt')
torch.save(y_train,'CWRU/presplit/arxiv_singlechannel/y_train.pt')
torch.save(y_test,'CWRU/presplit/arxiv_singlechannel/y_test.pt')